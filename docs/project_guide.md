...
### [src/api/jobs.py](../src/api/jobs.py)
...
### [src/core/ingest.py](../src/core/ingest.py)
...
### [src/core/scrape.py](../src/core/scrape.py)
...
### [src/core/analyze.py](../src/core/analyze.py)
...
### [src/core/service_map.py](../src/core/service_map.py)
...
### [src/core/generate.py](../src/core/generate.py)
...
### [src/core/review.py](../src/core/review.py)
...
### [src/core/send.py](../src/core/send.py)
...
### [src/utils/url.py](../src/utils/url.py)
...
### [src/integrations/pagespeed.py](../src/integrations/pagespeed.py)
...
### [src/llm/validate.py](../src/llm/validate.py)
...
### [src/llm/bakeoff.py](../src/llm/bakeoff.py)
...
### [tests/test_scrape.py](../tests/test_scrape.py)
...
### [tests/test_service_map.py](../tests/test_service_map.py)
...
### [tests/test_send_dryrun.py](../tests/test_send_dryrun.py)
